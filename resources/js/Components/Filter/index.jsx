...
const filters = [
    {
        ...
        options: [
            ...
            { value: "bhaktapur", label: "Bhaktapur", checked: false },
            { value: "lalitpur", label: "Lalitpur", checked: false },
        ],
    },
    {
        id: "price",
        name: "Price Range",
        options: [
            { value: "300-500", label: "रु 300 - रु 500", checked: false },
            { value: "501-1000", label: "रु 501 - रु 1000", checked: false },
            {
                value: "1001-2000",
...
export default function Filter({ futsal_listings }) {
